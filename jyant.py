...
with st.sidebar:
    GROQ_API_KEY = st.text_input("GROQ_API_KEY", key="chatbot_api_key", type="password")
    if GROQ_API_KEY:  # Only set if the key is entered
        os.environ["GROQ_API_KEY"] = GROQ_API_KEY
    else:
        st.warning("⚠️ Please enter your GROQ API key.")

with st.sidebar:
    NOMIC_API_KEY = st.text_input("NOMIC API KEY", key="chatbot_api", type="password")
    if NOMIC_API_KEY:  # Only set if the key is entered
        os.environ["NOMIC_API_KEY"] = NOMIC_API_KEY
    else:
        st.warning("⚠️ Please enter your Nomic API key.")
